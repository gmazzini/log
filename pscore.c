...
void conscore(MYSQL *con,char tok[][100],char *mycall){
  int contype,c,gg,vv,cqz[1000],ituz[1000],d,e,n,h,m,z;
  long l1,l2;
  ...
  for(;;){
    ...
    switch(contype){
      ...
      case 36: { // CQWPXRTTY
        ...
        incdata3(0,0,aux1,1,0);
        if(strncmp(cont[vv],cont[gg],2)!=0){if(c<=20)incdata3(0,1,aux1,3,0); else incdata3(0,1,aux1,6,0);}
        else if(gg!=vv){if(c<=20)incdata3(0,1,aux1,2,0); else incdata3(0,1,aux1,4,0);}
      ...
      case 42: { // HOLYLANDDX 4x=336
        ...
        if(gg==336){
          ...
          else if(strncmp(cont[vv],cont[gg],2)==0)incdata3(0,1,aux1,2,0);
          else incdata3(0,1,aux1,8,0);
          if(vv==336){
            sprintf(aux2,"%03d:%s",c,row[4]);
            incdata3(0,2,aux2,1,0); incdata3(0,3,aux2,1,0);
      ...
      case 44: { // UNDX UN=130
        ...
        if(gg==130){
          ...
          if(vv==130)incdata3(0,1,aux1,10,0);
          else if(vv==gg)incdata3(0,1,aux1,2,0);
          else if(strncmp(cont[vv],cont[gg],2)==0)incdata3(0,1,aux1,3,0);
          else incdata3(0,1,aux1,5,0);
        }
        sprintf(aux2,"%03d:%d",c,vv);
      ...
      case 46: { // CQBB I=248
        ...
        sprintf(aux1,"%03d:%s:%s",c,row[0],mymode(row[5]));
        incdata3(0,0,aux1,1,0);
        if(strncmp(mymode(row[0]),"IQ",2)==0||strncmp(mymode(row[0]),"IY",2)==0)incdata3(0,1,aux1,10,0);
        else if(strncmp(mymode(row[5]),"CW",2)==0)incdata3(0,1,aux1,2,0);
        else incdata3(0,1,aux1,1,0);
        sprintf(aux2,"%03d:%.2s",c,row[4]);
        incdata3(0,2,aux2,1,0); incdata3(0,3,aux2,1,0);
        if(strlen(row[4])>2){
      ...
      case 48: { // RRTC
        ...
        incdata3(0,0,aux1,1,0);
        if(!isdigit(row[4][0]))incdata3(0,1,aux1,1,0);
        else if(ituz[gg]==ituz[vv])incdata3(0,1,aux1,2,0);
        else incdata3(0,1,aux1,3,0);
        if(!isdigit(row[4][0])){
      ...
      case 59: { // EIUKDXCW
        sprintf(aux1,"%03d:%s",c,row[0]);
        incdata3(0,0,aux1,1,0);
        int lll[] =  {245, 223, 114, 265, 122, 279, 106, 294};
        n=sizeof(lll)/sizeof(lll[0]);
        for(d=0;d<n;d++)if(gg==lll[d])break;
        for(e=0;e<n;e++)if(vv==lll[e])break;
        if(d<n){
        ...
        else if(strncmp(cont[gg],"EU",2)==0){
          if(e<n || strncmp(cont[vv],"EU",2)!=0){
      ...
      case 60: { // RAC VA=1
        ...
        incdata3(0,0,aux1,1,0);
        if(vv==1){
          if(strncmp(row[0]+3,"RAC",3)==0)incdata3(0,1,aux1,20,0);
