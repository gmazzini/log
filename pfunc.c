...
struct bandplane bands[] = {
  {"160","CW",1810000,1838000},
  {"160","DG",1838000,1843000},
  {"160","PH",1843000,2000000},
  {"80","CW",3500000,3570000},
  {"80","DG",3570000,3600000},
  {"80","PH",3600000,3800000},
  {"40","CW",7000000,7040000},
  {"40","DG",7040000,7080000},
  {"40","PH",7060000,7200000},
  {"20","CW",14000000,14070000},
  {"20","DG",14070000,14112000},
  {"20","PH",14112000,14350000},
  {"15","CW",21000000,21070000},
  {"15","DG",21070000,21151000},
  {"15","PH",21151000,21450000},
  {"10","CW",28000000,28070000},
  {"10","DG",28070000,28320000},
  {"10","PH",28320000,29700000},
  {"30","CW",10100000,10130000},
  {"30","DG",10130000,10150000},
  {"17","CW",18068000,18095000},
  {"17","DG",18095000,18111000},
  {"17","PH",18111000,18168000},
  {"12","CW",24890000,24915000},
  {"12","DG",24915000,24931000},
  {"12","PH",24931000,24990000},
  {"60","CW",5151500,5153000},
  {"60","DG",5154000,5366000},
  {"60","PH",5366000,5366500},
}
...
void qrzcom(MYSQL *con,char *call){
  ...
  printf("<pre>"); for(n=0;n<13;n++)printf("%s: %s\n",qrzkey[n],key[n]); printf("</pre>");
  if(key[0][0]!='\0'){
...
void qrzru(MYSQL *con,char *call){
  ...
  printf("<pre>"); for(n=0;n<12;n++)printf("%s: %s\n",qrzkey[n],key[n]); printf("</pre>");
  now=time(NULL); utc=gmtime(&now); strftime(ee,39,"%Y-%m-%d %H:%M:%S",utc);
  if(key[0][0]!='\0'){
