...
int main(void){
  ...
  if(act==10){
    ...
    printf("<p id=\"myh2\">%10s %7ld %8ld %8ld %8ld %8ld %8ld</p>","Tot",suml[0],0L,0L,suml[1],suml[2],suml[3]);
    ...
    printf("<p id=\"myh2\">%10s %7ld %8ld %8ld %8ld %8ld %8ld</p>","Tot",suml[4],0L,0L,suml[5],suml[6],suml[7]);
