...
int main(void){
  ...
  if(act==10){
   ...
   // for(c=0;c<4;c++)for(suml[c]=0,l1=0;l1<ndata2[c];l1++)suml[c]+=data2[c][l1].num;
    ...
    for(l1=0;l1<ndata3[0][0];l1++)printf("%6s %7ld %8ld %8ld %8ld %8ld %8ld\n",data3[0][0][l1].lab,data3[0][0][l1].num,ndata3[1][data3[0][0][l1].idx],ndata3[2][data3[0][0][l1].idx],numdata3(0,1,data3[0][0][l1].lab),numdata3(0,2,data3[0][0][l1].lab),numdata3(0,3,data2[0][0][l1].lab));
    printf("\n");
    ...
    for(l1=0;l1<ndata2[4];l1++){
      printf("%6s %7ld %8ld %8ld %8ld %8ld %8ld",data2[4][l1].lab,data2[4][l1].num,ndata3[2][data2[4][l1].idx],ndata3[4][data2[4][l1].idx],numdata3(0,5,data2[4][l1].lab),numdata3(0,6,data2[4][l1].lab),numdata3(0,7,data2[4][l1].lab));
